  ...
  describe.only("Tab", () => {
         ...
         it("can find the text test tab 1", () =>{
          ...
          cy.get(
            ...
            cy.get('div[button_id="d30d565b-b56c-475b-be1b-b148f2cae4dc"]').click()
            cy.get('div')   
          ...
          //2. can find the text "test tab 2"
           it("can find the text test tab 2", () =>{
            ...
            cy.get(
              ...
              cy.get('div[button_id="72167997-ce58-4a92-a330-203cbdd7e070"]').click()
              cy.get('div')   
          ...
          it("can find the text test tab 3", () =>{
            ...
            cy.get(
              ...
              cy.get('div[button_id="173fdd14-cc17-46ff-9996-0668c13429cd"]').click()
              cy.get('div')   
          ...
          it("can find the text test tab 4", () =>{
            ...
            cy.get(
              ...
              cy.get('div[button_id="89fc053f-29a6-4148-b7f5-78709b12982d"]').click()
              cy.get('div')   
          ...
          it("can find the text test tab 5", () =>{
            ...
            cy.get(
              ...
              cy.get('div[button_id="3441a8bb-7209-4e0e-95ec-4cf6f2a234b7"]').click()
              cy.get('div')   
