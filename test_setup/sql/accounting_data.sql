...
CREATE PROCEDURE `INSERT_BATCHES` (
   ...
   WHILE @i <= ROUNDS DO
      INSERT INTO `AB_AccountingApp_Batch`
         (`uuid`, `created_at`, `updated_at`, `Status`,`date`,`Post Period`, `Jrn Code`)
      VALUES
...
BEGIN
   ...
   WHILE @i <= ROUNDS DO
      INSERT INTO `AB_AccountingApp_JournalEntry`
         (`uuid`, `created_at`, `updated_at`, `Date`, `Ref Name`, `Memo`, `Debit`, `Credit`, `RC Code`, `Account`, `Batch Index`)
      VALUES (
         UUID(),
         NOW(),
         NOW(),
...
BEGIN
   ...
   WHILE @i <= ROUNDS DO
      INSERT INTO `AB_AccountingApp_JEArchive`
         (`uuid`, `created_at`, `updated_at`, `Date`, `Ref Number`, `Description`, `Debit`, `Credit`, `Batch Index`)
      VALUES (
         UUID(),
         NOW(),
         NOW(),
...
INSERT INTO `AB_AccountingApp_FiscalMonth`
   (`uuid`, `created_at`, `updated_at`, `FY Per`, `Start`, `End`, `Open`, `Status`, `FYear`)
VALUES
...
INSERT INTO TEAM_TYPE(`Type`) VALUES ("GCM"),("Others"),("National"),("Operations"),("City"),("Field");
